...
model TestRecuperation "Test with and without recuperation"
  ...
  Chassis.Car2Axle car2Axle(a(start = 0), s(start = 0, fixed = true), vehicleData = vehicleData,
    v(start=drivingCycle.v0,
      fixed=true,
      displayUnit="m/s"))  annotation (
  ...
  parameter EMOTH.ParameterRecords.ElectricDrives.GenericDrives.DriveTestData
                                                                         driveData
  annotation (
    Placement(transformation(extent={{-40,-50},{-20,-30}})));
  EMOTH.ElectricDrives.GenericDrive genericDrive(driveData=driveData,
