...
model TestWithDriver "Test with driver over a driving cycle"
  ...
  Brakes.Brakes4wheels brakes4wheels(vehicleData=vehicleData, includeHeatPort=false)
    annotation (Placement(transformation(extent={{70,-10},{90,10}})));
  DriveLines.RearAxleDrive rearAxleDrive(vehicleData=vehicleData, includeHeatPort=false)
  ...
  ElectricDrives.GenericDrive genericDrive(driveData=driveData, includeHeatPort=false)
    annotation (Placement(transformation(extent={{-40,-10},{-20,10}})));
  parameter EMOTH.ParameterRecords.EnergyStorages.BatteryTestData batteryData
    annotation (Placement(transformation(extent={{-80,-50},{-60,-30}})));
  EnergyStorages.SimpleBattery battery(batteryData=batteryData, includeHeatPort=false) annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=0,
        origin={-70,0})));
  ...
  EMOTH.Accessories.ElectricalAccessories electricalAccessories(P=5000)
    annotation (Placement(transformation(extent={{-60,-90},{-40,-70}})));
  EMOTH.Accessories.RangeExtender rangeExtender(P=6000)
...
equation
  ...
  connect(battery.pin_p, electricalAccessories.pin_p) annotation (Line(points={
          {-64,10},{-64,22},{-52,22},{-52,-58},{-44,-58},{-44,-70}}, color={0,0,
          255}));
  connect(battery.pin_n, rangeExtender.pin_n) annotation (Line(points={{-76,10},
          {-76,18},{-56,18},{-56,-62},{-16,-62},{-16,-70}}, color={0,0,255}));
  connect(battery.pin_p, rangeExtender.pin_p) annotation (Line(points={{-64,10},
          {-64,10},{-64,22},{-52,22},{-52,-58},{-4,-58},{-4,-70}}, color={0,0,
          255}));
  connect(battery.controlBus, electricalAccessories.controlBus) annotation (
      Line(
      points={{-80,-6},{-86,-6},{-86,-86},{-60,-86}},
      color={255,204,51},
      thickness=0.5));
  connect(electricalAccessories.controlBus, rangeExtender.controlBus)
    annotation (Line(
      points={{-60,-86},{-86,-86},{-86,-94},{-24,-94},{-24,-86},{-20,-86}},
      color={255,204,51},
      thickness=0.5));
